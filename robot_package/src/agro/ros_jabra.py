...
if __name__ == "__main__":
    print('start')
    jabra_name = sys.argv[1]
    print(jabra_name)
    x,y = [1920, 1080]
    camera = Camera(port='video'+str(jabra_name), name='jabra_'+str(jabra_name), index=int(jabra_name), width=x, height=y)
    camera.getFrame()
    #camera.write('/home/aida/scripts/'+filename + '.avi')